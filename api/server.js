...
const initializeDatabase = () => {
  const queries = [
    ...
    "INSERT IGNORE INTO `Candidates` (`resume_id`, `interview`, `f_name`, `l_name`) VALUES (1, 'https://youtu.be/aA7k6WM4_7A', 'Aisha', 'Patel')",
    "INSERT IGNORE INTO `Candidates` (`resume_id`, `interview`, `f_name`, `l_name`) VALUES (2, 'https://youtu.be/4d6v7p0N9Sg', 'Casey', 'Fisch')",
    "INSERT IGNORE INTO `Candidates` (`resume_id`, `interview`, `f_name`, `l_name`) VALUES (3, 'https://youtu.be/typ4aN11feI', 'Ethan', 'Martinez')",
    "INSERT IGNORE INTO `Candidates` (`resume_id`, `interview`, `f_name`, `l_name`) VALUES (4, 'https://youtu.be/ySKRfElNPCY', 'Jason', 'Jones')",
    "INSERT IGNORE INTO `Candidates` (`resume_id`, `interview`, `f_name`, `l_name`) VALUES (5, 'https://youtu.be/_KGOo1WGKZU', 'Lucas', 'Nyugen')",
    "INSERT IGNORE INTO `Candidates` (`resume_id`, `interview`, `f_name`, `l_name`) VALUES (6, 'https://youtu.be/AhJrqbDTn1Y', 'Maya', 'Collins')",
    ...
    "INSERT IGNORE INTO `Interview_vids` (`resume_id`, `title`, `video_path`) VALUES (4, 'Interview5', 'https://youtu.be/ySKRfElNPCY')",
    "INSERT IGNORE INTO `Interview_vids` (`resume_id`, `title`, `video_path`) VALUES (5, 'Interview5', 'https://youtu.be/_KGOo1WGKZU')",
    "INSERT IGNORE INTO `Interview_vids` (`resume_id`, `title`, `video_path`) VALUES (6, 'Interview6', 'https://youtu.be/AhJrqbDTn1Y')",
