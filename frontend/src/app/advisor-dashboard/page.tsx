    ...
    <div className="flex flex-col min-h-screen bg-northeasternWhite font-rubik">
      ...
      <main className="flex flex-col items-center justify-center flex-grow z-10">
        <div className="mt-6 gap-6 flex flex-row justify-center items-center">
            <Link
              href="/grouping"
              className="px-8 py-8 bg-northeasternWhite text-northeasternRed border-4 border-northeasternRed font-semibold rounded-4xl shadow-xl hover:bg-northeasternRed hover:text-northeasternWhite transition flex flex-col items-center justify-center text-center text-lg w-48 h-48"
            >
